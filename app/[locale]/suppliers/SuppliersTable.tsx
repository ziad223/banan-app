// app/suppliers/components/SuppliersTable.tsx
'use client';

import { FaEye, FaShoppingCart, FaTrashAlt, FaStar, FaPhone } from 'react-icons/fa';
  ...
  const columns = [
    { 
      ...
      render: (_: any, row: any) => (
        <div className="text-center font-mono font-bold">{row.id}</div>
      )
    },
    { 
      key: "name",
    ...
    { 
      ...
      render: (_: any, row: any) => (
        <div className={`font-bold text-lg ${
          row.balance < 0 ? 'text-green-600' : 'text-gray-600'
        }`}>
